...
impl ExprEngine{
    ...
    pub fn register_rule_by_expr<S:Into<String>,E:AsRef<str>>(&mut self,name:S,calc:E,exec:E)->anyhow::Result<()>{
        //先解析calc
...
impl IntoIterator for ExprEngine{
    ...
    fn into_iter(self) -> Self::IntoIter {
        self.rules.into_iter().map(|(n,(c,a))|(n,c,a)).collect::<Vec<_>>().into_iter()
    }
}
